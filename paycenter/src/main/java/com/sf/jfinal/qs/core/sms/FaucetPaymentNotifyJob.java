 ...
 */
public class FaucetPaymentNotifyJob extends PaymentNotifyJob {
    //17756016668，13966792733，18555111666
    public FaucetPaymentNotifyJob(String buyer, String buyerMobile, int buyNum) {
        List<String> interests = new ArrayList<>();
        interests.add("17756016668");
        interests.add("13966792733");
        interests.add("18555111666");
        String msg = String.format(MSG_TMPL, buyNum + "个" + "止水龙头", "我们会尽快给您邮寄");
