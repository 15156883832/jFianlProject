...
public abstract class BaseCrmGoodsPlatformOrder<M extends BaseCrmGoodsPlatformOrder<M>> extends Model<M> implements IBean {
	...
	public void setHadLogisticsPrice(String hadLogisticsPrice) {
		set("had_logistics_price", hadLogisticsPrice);
	}

	public String getHadLogisticsPrice() {
		return get("had_logistics_price");
	}
	...
	public void setUserSiteMsg(String userSiteMsg) {
		set("user_site_msg", userSiteMsg);
	}

	public String getUserSiteMsg() {
		return get("user_site_msg");
	}
	...
	public void setOutStockType(String outStockType) {
		set("out_stock_type", outStockType);
	}

	public String getOutStockType() {
		return get("out_stock_type");
	}
