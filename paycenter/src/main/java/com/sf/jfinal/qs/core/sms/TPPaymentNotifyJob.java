 ...
 */
public class TPPaymentNotifyJob extends PaymentNotifyJob {
    // 13261321718，13966792733，18555111666
    public TPPaymentNotifyJob(String buyer, String buyerMobile, int buyNum) {
        List<String> interests = new ArrayList<>();
        interests.add("13966792733");
        interests.add("18555111666");
        String msg = String.format(MSG_TMPL, buyNum + "套" + "来电弹屏", "我们会尽快给您邮寄");
