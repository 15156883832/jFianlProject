...
/**
 * Add a image overlay to a qrcode.
 */
public class ImageOverlay implements QRCodeDecorator<BufferedImage> {
     ...
     * @param overlayTransparency  The overlays transparency from 0..1 where one is no transparency, default is set to 1.
    ...
    public BufferedImage decorate(BufferedImage qrcode) {
        ...
        g2.drawImage(scaledOverlay, Math.round(deltaWidth / 2.0f), Math.round(deltaHeight / 2.0f), null);
